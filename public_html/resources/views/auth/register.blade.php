        ...
        <div class="container w-4/5 md:w-3/5 lg:w-1/3 mt-3 shadow-2xl p-3  bg-white" style="height:fit-content;" >
            <ul class="nav nav-pills w-full flex flex-row justify-between" id="myTabn" role="tablist">
                <li class="nav-item flex-1" role="presentation">
                    <a class="nav-link  text-center mr-2 hover:bg-gray-100 " id="login-tab" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="true">
                        {{ __('Login')}} 
                    </a>
                </li>
                <li class="nav-item flex-1" role="presentation">
                    <a class="nav-link active text-center ml-2 hover:bg-gray-100" id="sign-tab" data-toggle="tab" href="#register" role="tab" aria-controls="register" aria-selected="false">
                        {{ __('Sign in')}} 
                    </a>
                </li>
            </ul>
